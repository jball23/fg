...
contract E30 is Ownable, ERC721A, ReentrancyGuard {
    ...
    ) ERC721A("E30", "E30", maxBatchSize_, collectionSize_) {
        maxPerAddressDuringMint = maxBatchSize_; // total allowed to mint per wallet
        amountForAuctionAndDev = amountForAuctionAndDev_; // amount available to mint at auction and for devs
        amountForDevs = amountForDevs_; // amount to reserve for devs
        require(
    ...
    // sets the quantity available for mint
